        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#nosotros" className="hover:text-blue-400 transition-colors">Acerca de Nosotros</Link>
              </li>
              <li>
                <Link href="/noticias" className="hover:text-blue-400 transition-colors">Noticias</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>Av. Principal 1234, El Valle</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <form className="mb-4">
              <div className="flex">
                <input 
                  ...
                  className="px-4 py-2 w-full text-gray-900 focus:outline-none rounded-l"
                />
                <button 
                  type="submit"
