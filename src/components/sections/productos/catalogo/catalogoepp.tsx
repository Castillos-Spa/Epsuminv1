      ...
      <div className="bg-white bg-[url('/img/fondo_catalogo.png')] bg-cover bg-center py-6 xl:py-8">
        <div className="container mx-auto px-4 xl:px-8 2xl:px-16">
          ...
          <div className="relative mb-0 flex flex-col items-center md:flex-row md:justify-between">
            {/* Recuadro naranja con información - reducido */}
            <div className="w-full rounded-lg bg-orange-400 p-4 md:w-3/4 xl:w-3/4 2xl:w-3/4 md:ml-6 md:mr-6 2xl:mr-2">
              <div className="grid grid-cols-1 gap-2 md:grid-cols-2 md:gap-3">
                {/* Primera columna - más compacta */}
                <div className="text-xs xl:text-sm leading-tight">
              ...
              <div className="mt-3 flex justify-end">
                <Link
                  href="#contactar"
                  className="rounded-full bg-white px-6 py-1.5 text-sm font-medium text-gray-800 transition-colors hover:bg-gray-100 border-2 border-azul-cyan-300 xl:px-8 xl:py-2"
                >
                  CONTACTAR
                </Link>
              </div>
